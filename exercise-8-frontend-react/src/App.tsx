  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <p>Simple frontend for simplified Todo API</p>
      </header>
      ...
      <footer className="app-footer">
        <p>
          🚀 Built with <strong>React</strong> + <strong>TypeScript</strong> + <strong>Vite</strong>
        </p>
        <p>
          🔗 Connected to <strong>Simple Hono API</strong> on {API_BASE_URL}
        </p>
      </footer>
    </div>
  );
